...
function sf_siteplan_shortcode($atts, $content="") {
    ...
    ob_start();
?>
    <div class="siteplan <?php echo $class; ?>">        
        ...
        while ( $loop->have_posts() ) : $loop->the_post();
            ...
            echo "<li data-toggle=\"popover\" title=\"Lot ".get_the_title().": $status\" data-content=\"".htmlspecialchars($description)."\" class=\"siteplan-lot siteplan-lot-$status\" style=\"left:".$lat."px;top:".$lng."px;\">";
